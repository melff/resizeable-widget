...
# -*- coding: utf-8 -*-
#
# resizeable_widget documentation build configuration file
#
...
project = 'resizeable_widget'
copyright = '2024, Martin Elff'
author = 'Martin Elff'
...
_version_py = os.path.join(repo, 'resizeable_widget', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'resizeable_widgetdoc'
...
latex_documents = [
    (master_doc, 'resizeable_widget.tex', 'resizeable_widget Documentation',
     'Martin Elff', 'manual'),
]
...
man_pages = [
    (master_doc,
    'resizeable_widget',
    'resizeable_widget Documentation',
     [author], 1)
]
